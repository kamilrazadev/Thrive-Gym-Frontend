...
const features = [
  ...
  },
  {
    ...
    image:
      "https://images.unsplash.com/photo-1549060279-7e168fcee0c2?q=80&w=1400&auto=format&fit=crop",
    glowPos: "right",
    imgSide: "right",
  },
  {
  ...
  return (
    <section className="relative overflow-hidden bg-black">
      ...
      <div className="pt-10 md:pt-16 pb-8 md:pb-10 text-center relative">
        <div className="absolute inset-0 bg-[radial-gradient(ellipse_at_50%_100%,rgba(244,5,50,0.07),transparent_65%)] pointer-events-none" />
        <div className="relative z-10 max-w-7xl mx-auto px-4 sm:px-6">
          ...
          <h2
            className="font-black uppercase tracking-[4px] leading-[0.9] text-white mb-5"
            style={{ fontSize: "clamp(2.8rem, 6vw, 5.5rem)" }}
          >
            EVERYTHING YOU NEED.
            <br />
            <span className="text-[#F40532]">NOTHING YOU DON'T.</span>
          </h2>
          <p className="text-white/40 max-w-xl mx-auto font-medium text-lg leading-relaxed">
            We've stripped away the fluff and doubled down on what actually
            drives results.
          </p>
        </div>
      </div>
...
function FeaturePanel({ feature: f, index }) {
  ...
  return (
    ...
    >
      ...
      <div
        className={`absolute top-1/2 -translate-y-1/2 w-[500px] h-[500px] bg-[#F40532]/12 blur-[130px] rounded-full pointer-events-none ${
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 w-full grid grid-cols-1 lg:grid-cols-2 items-center gap-0">
        ...
        >
          ...
          <div className="flex items-center gap-3 mb-6">
            <div className="w-10 h-10 rounded-xl bg-[#F40532]/12 border border-[#F40532]/20 flex items-center justify-center">
              <f.icon className="w-5 h-5 text-[#F40532]" />
            </div>
            <span className="text-[#F40532] font-black text-xs uppercase tracking-[0.35em]">
              {f.tag}
            </span>
          ...
          {/* Title */}
          <h3
            className="font-black uppercase tracking-[4px] leading-[0.88] text-white mb-6 whitespace-pre-line"
          ...
          {/* Stat */}
          <div className="flex items-center gap-3 mb-6">
            <div className="bg-[#F40532] rounded-xl px-5 py-3 shadow-lg shadow-[#F40532]/25">
          ...
          <a
            href="#membership"
            className="group inline-flex items-center gap-3 text-white/60 hover:text-[#F40532] font-black uppercase tracking-widest text-xs transition-colors duration-200"
          >
        ...
        >
          ...
          <div className="absolute inset-0 flex items-center justify-center pointer-events-none">
            <div className="w-72 h-72 bg-[#F40532]/15 blur-[80px] rounded-full" />
          </div>
          ...
          <div className="relative w-full max-w-[480px] mx-auto">
            ...
            <div
              className={`absolute bottom-0 h-[2px] w-32 bg-gradient-to-r from-[#F40532] to-transparent ${
