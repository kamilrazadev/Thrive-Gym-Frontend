...
const trainers = [
  ...
  },
  {
    ...
    classes: 16,
    image:
      "https://images.unsplash.com/photo-1611672585731-fa10603fb9e0?q=80&w=800&auto=format&fit=crop",
  },
  {
    slug: "dax-merritt",
    name: "Dax Merritt",
...
export default function Trainers() {
  return (
    <section
      ...
      id="trainers"
    >
      <div className="absolute inset-0 bg-[radial-gradient(ellipse_at_30%_50%,rgba(244,5,50,0.04)_0%,transparent_60%)] pointer-events-none" />
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6">
        ...
        <div className="flex flex-col items-center gap-4 text-center mb-14">
          ...
          >
            MEET YOUR <span className="text-[#F40532]">COACHES</span>
          </h2>
          <p className="text-white/40 max-w-lg font-medium text-lg leading-relaxed">
            Certified, passionate, and relentless. Our coaches don't just teach
          ...
          {trainers.map((t, i) => (
            ...
            >
              <Link href={`/trainers/${t.slug}`} className="block">
                <div className="relative rounded-[26px] overflow-hidden border border-white/5 group-hover:border-[#F40532]/25 transition-all duration-300">
                  {/* Image */}
                  <div className="relative h-100 sm:h-85 overflow-hidden">
                    <img
                      src={t.image}
                      alt={t.name}
                    ...
                    {/* Classes badge */}
                    <div className="primary-gradient-badge absolute top-3 right-3 rounded-full px-2 py-1">
                    ...
                    <div className="absolute bottom-4 left-0 right-0 flex justify-center translate-y-20 group-hover:translate-y-0 transition-transform duration-500 ease-out">
                      <div className="primary-gradient-badge flex items-center gap-1 p-2 rounded-2xl shadow-2xl shadow-[#F40532]/30">
                  ...
                  {/* Info */}
                  <div className="p-4 bg-zinc-950 group-hover:bg-[#F40532]/5 transition-colors duration-300">
                    <h3 className="text-white font-black uppercase tracking-[4px] text-lg leading-none">
                      {t.name}
                    </h3>
                    <p className="text-[#F40532] font-bold uppercase tracking-widest text-xs mt-1">
                      {t.role}
                    </p>
                    <p className="text-white/30 text-xs font-medium mt-1 opacity-100 sm:opacity-0 sm:group-hover:opacity-100 transition-opacity duration-300">
                      {t.specialty}
                    </p>
                  </div>
                </div>
        ...
        >
          <div>
            <h3 className="text-xl font-black text-white uppercase tracking-[4px]">
              Want 1-on-1 Personal Training?
            </h3>
            <p className="text-white/40 font-medium text-sm mt-1">
              Book a session with any of our certified coaches.
            </p>
          </div>
          <a
            href="#contact"
            className="primary-gradient-btn shrink-0 text-white font-black uppercase tracking-widest text-xs px-7 py-3.5 rounded-full transition-all hover:brightness-105 hover:shadow-[0_0_25px_rgba(244,5,50,0.4)] hover:-translate-y-px"
          >
            Book a Session
          </a>
        </motion.div>
